...
class AuthInformation {
  ...
  AuthInformation.fromResponse(AuthorizationTokenResponse? authTokenResponse, TokenResponse? tokenResponse,
    ...
    accessTokenExpirationDateTime =
        authTokenResponse?.accessTokenExpirationDateTime ?? tokenResponse?.accessTokenExpirationDateTime;
  ...
  factory AuthInformation.fromJson(Map<String, dynamic> json) => _$AuthInformationFromJson(json);
